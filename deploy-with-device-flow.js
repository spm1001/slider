...
class AppsScriptDeviceFlowDeployer {
  constructor() {
    this.auth = null;
    this.drive = null;
  ...
  async authenticate() {
    console.log('🔐 Authenticating with Google APIs (Device Flow)...');
    ...
    try {
      ...
      console.log('🔄 No valid token found, starting device authentication flow...');
...
Please ensure your credentials.json file is in the project directory.
  ...
  async getDeviceToken() {
    // Generate auth URL with out-of-band redirect URI
    ...
    console.log(authUrl);
    console.log('');
    console.log('📋 After authorizing, copy the authorization code from the browser');
    console.log('   (it will be displayed on a page after you grant permissions)');
    console.log('');
...
// Main execution
async function main() {
  const deployer = new AppsScriptDeviceFlowDeployer();
...
module.exports = AppsScriptDeviceFlowDeployer;